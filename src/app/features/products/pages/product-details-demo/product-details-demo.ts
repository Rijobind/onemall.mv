...
@Component({
  selector: 'app-product-details-demo',
  imports: [CommonModule, FormsModule, RouterModule, Header, Footer],
  templateUrl: './product-details-demo.html',
  styleUrl: './product-details-demo.css',
})
export class ProductDetailsDemo implements OnInit {
